...
public class BareBonesBrowserLaunch {
	...
	public static void openURL(String url) {
		...
		try {
			...
			desktop.getDeclaredMethod("browse", new Class[] { java.net.URI.class }).invoke(
					desktop.getDeclaredMethod("getDesktop").invoke(null), new Object[] { java.net.URI.create(url) });
