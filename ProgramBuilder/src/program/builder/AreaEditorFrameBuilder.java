...
public class AreaEditorFrameBuilder extends AreaEditorFrameBase {
	...
	/**
	 * Start area editor panel.
	 */
	private AreaStartPanel panelAreaStart;
	 ...
	 * @param area 
	 */
	public AreaEditorFrameBuilder(Component parentComponent, Area area) {
	...
	private void initComponents() {
		...
		setTitle(Resources.getString("org.multipage.generator.textAreaEditor"));
		...
		buttonSaveAndClose.setPreferredSize(new Dimension(140, 26));
		buttonSaveAndClose.setMargin(new Insets(2, 4, 2, 4));
		bottomPanel.add(buttonSaveAndClose);
		...
		sl_panel.putConstraint(SpringLayout.EAST, checkBoxIsDisabled, -30, SpringLayout.EAST, buttonSaveDescription);
	...
	protected void onSaveAndClose() {
		try {
			...
			panelInheritance.onClose();
			panelResources.onClose();
			panelAreaStart.onClose();
			panelDependencies.onClose();
			panelAreaHelpEditor.onClose();
			panelConstructors.onClose();
			
			super.onSaveAndClose();
		}
