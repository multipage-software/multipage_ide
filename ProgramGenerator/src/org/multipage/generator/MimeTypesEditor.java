...
/**
 * Dialog that displays list of MIME types.
 * @author vakol
 *
 */
	...
	private void loadToolBar() {
		try {
			...
			ToolBarKit.addToolBarButton(toolBar, "org/multipage/generator/images/add_item_icon.png",
					"org.multipage.generator.tooltipNewMimeType", () -> onNewMime());
			ToolBarKit.addToolBarButton(toolBar, "org/multipage/generator/images/rename_node.png",
					"org.multipage.generator.tooltipRenameMimeType", () -> onRename());
			ToolBarKit.addToolBarButton(toolBar, "org/multipage/generator/images/remove_icon.png",
					"org.multipage.generator.tooltipDeleteMimeType", () -> onDelete());
			toolBar.addSeparator();
			ToolBarKit.addToolBarButton(toolBar, "org/multipage/generator/images/update_icon.png",
					"org.multipage.generator.tooltipUpdateMimeTypes", () -> onUpdate());
			toolBar.addSeparator();
			ToolBarKit.addToolBarButton(toolBar, "org/multipage/generator/images/select_all.png",
					"org.multipage.generator.tooltipSelectAllMimeTypes", () -> onSelectAll());
			ToolBarKit.addToolBarButton(toolBar, "org/multipage/generator/images/deselect_all.png",
					"org.multipage.generator.tooltipUnselectAllMimeTypes", () -> onUnselectAll());
		}
		catch(Throwable expt) {
			Safe.exception(expt);
		};
