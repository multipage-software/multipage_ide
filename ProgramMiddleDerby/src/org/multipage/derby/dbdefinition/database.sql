...
CREATE TABLE APP.AREA (
	...
	START_RESOURCE BIGINT,								   -- CAN BE REMOVED
	DESCRIPTION_ID BIGINT,
	...
	VERSION_ID BIGINT,									   -- CAN BE REMOVED
	FOLDER VARCHAR(4096),
	CONSTRUCTORS_GROUP_ID BIGINT,
	CONSTRUCTOR_HOLDER_ID BIGINT,
	START_RESOURCE_NOT_LOCALIZED BOOLEAN,				   -- CAN BE REMOVED
...
CREATE TABLE APP.AREA_SLOT (
	...
	REVISION_DESCRIPTION VARCHAR(80),
...
CREATE TABLE APP.SUBAREA_CONSTRUCTORS (
	ID BIGINT NOT NULL,
	CONSTRUCTOR_HOLDER_ID BIGINT NOT NULL,
	CONSTRUCTOR_GROUP_ID BIGINT NOT NULL,	
	PRIMARY KEY (CONSTRUCTOR_HOLDER_ID, CONSTRUCTOR_GROUP_ID)
);

ALTER TABLE APP.SUBAREA_CONSTRUCTORS
	ADD FOREIGN KEY (CONSTRUCTOR_HOLDER_ID) 
	REFERENCES APP.CONSTRUCTOR_HOLDER (ID);
	
ALTER TABLE APP.SUBAREA_CONSTRUCTORS
	ADD FOREIGN KEY (CONSTRUCTOR_GROUP_ID) 
	REFERENCES APP.CONSTRUCTOR_GROUP (ID);	
